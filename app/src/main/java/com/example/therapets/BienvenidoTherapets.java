...
public class BienvenidoTherapets extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Cargar el diseño de la pantalla de bienvenida
        setContentView(R.layout.activity_bienvenido_therapets);

        // Aplicar padding automático para que el contenido no se solape con la barra de notificaciones ni los botones del móvil
